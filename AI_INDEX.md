...
| `buildRenderCommands` | .cpp:1583-1700 | 出命令总入口 |
| `visibleBucketKeys` | .cpp:1701-1770 | 可见桶筛选 |
| `updateLabelPlacement` | .cpp:1771-1844 | 标签避让 + fade + 地平线剔除(P5c) |
| `appendTerrainOcclusion` | .cpp:1890-1901 | 接地形深度 prepass 做符号遮挡(T2) |
| `appendBucketCommands` | .cpp:1902-2190 | 逐桶发命令:stencil 贴地面、贴地线、点符号/图标、标签 |
| `beginEditPreview` / `updateEditPreview` / `endEditPreview` | .cpp:2191-2206 / :2207-2213 / :2214-2239 | 编辑预览三接口(**编辑器本身不进引擎**,见该决策) |
| `pick` | .cpp:2283-2501 | 要素拾取 |
