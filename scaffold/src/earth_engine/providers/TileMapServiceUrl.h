...
/// Cesium-native TileMapServiceRasterOverlay provider base URL:
/// keep the original endpoint for resolving TileSet hrefs, adding a trailing
/// slash only when Cesium does so before constructing the tile provider.
