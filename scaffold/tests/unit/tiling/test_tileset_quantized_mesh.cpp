...
struct TilesetTestAccess {
    ...
    static std::unique_ptr<Tileset> makeLegacyOnlyTilesetForMigrationTest(
        ...
        providers.legacyHeightmapTerrainProvider =
    ...
    static const TerrainProvider* effectiveLegacyTerrainProvider(
        const Tileset& tileset) {
        return tileset.legacyHeightmapTerrainProvider_.get();
    }
...
TEST(TilesetQuantizedMeshTest,
    ...
    EXPECT_DOUBLE_EQ(0.0, root->content.renderContent.terrainMaximumHeight());
