...
TileAvailabilitySubtree makeInvalidSubtreeAvailabilityRootSubtree() {
    return TileAvailabilitySubtree{
        ConstantTileAvailability{true},
        ConstantTileAvailability{true},
...
TEST(TileQuadtreeAvailabilityTest, GlobalQueryRejectsLevelsAboveMaximumLikeCesiumNative) {
    TileQuadtreeAvailability availability(3, 2);
    ASSERT_TRUE(availability.addSubtree(0, 0, 0, makeQuadtreeFixtureRootSubtree()));
    const TileAvailabilityNode* root = availability.rootNode();
    ASSERT_NE(nullptr, root);

    EXPECT_NE(0, availability.computeAvailability(2, 0, 0));
    EXPECT_EQ(0, availability.computeAvailability(3, 0, 0));
    EXPECT_NE(0, availability.computeAvailability(3, 0, 0, root));
}
...
TEST(TileQuadtreeAvailabilityTest, InvalidSubtreeAvailabilityAccessorMakesTraversalUnavailableLikeCesiumNative) {
    ...
    ASSERT_TRUE(availability.addSubtree(
        ...
        0,
        0,
        makeInvalidSubtreeAvailabilityRootSubtree()));
...
TEST(TileQuadtreeAvailabilityTest, AddSubtreeIgnoresMaximumLevelLikeCesiumNative) {
    TileQuadtreeAvailability availability(3, 2);
    ASSERT_TRUE(availability.addSubtree(0, 0, 0, makeQuadtreeFixtureRootSubtree()));

    EXPECT_TRUE(availability.addSubtree(
        3,
        0,
        0,
        TileAvailabilitySubtree{
...
TEST(TileQuadtreeAvailabilityTest, AddSubtreeRejectsInvalidSubtreeAvailabilityAccessorLikeCesiumNative) {
    TileQuadtreeAvailability availability(3, 5);
    ASSERT_TRUE(availability.addSubtree(
        0,
        0,
    ...
    EXPECT_FALSE(availability.addSubtree(
        ...
        TileAvailabilitySubtree{
            ...
            ConstantTileAvailability{false},
            {}}));
    EXPECT_EQ(nullptr, availability.findChildNode(3, 0, 0, root));
}
...
TEST(TileQuadtreeAvailabilityTest, AddNodeIgnoresMaximumLevelLikeCesiumNative) {
    TileQuadtreeAvailability availability(3, 2);
    ASSERT_TRUE(availability.addSubtree(0, 0, 0, makeQuadtreeFixtureRootSubtree()));
    TileAvailabilityNode* root = availability.rootNode();
    ASSERT_NE(nullptr, root);

    TileAvailabilityNode* node = availability.addNode(3, 0, 0, root);
    ASSERT_NE(nullptr, node);
    EXPECT_EQ(node, availability.findChildNode(3, 0, 0, root));
    EXPECT_EQ(0, availability.computeAvailability(3, 0, 0));
}
...
TEST(TileQuadtreeAvailabilityTest, AddNodeRejectsInvalidSubtreeAvailabilityAccessorLikeCesiumNative) {
    TileQuadtreeAvailability availability(3, 5);
    ASSERT_TRUE(availability.addSubtree(
        0,
        0,
    ...
    EXPECT_EQ(nullptr, availability.addNode(3, 0, 0, root));
    EXPECT_EQ(nullptr, availability.findChildNode(3, 0, 0, root));
}
...
TEST(TileOctreeAvailabilityTest, GlobalQueryRejectsLevelsAboveMaximumLikeCesiumNative) {
    TileOctreeAvailability availability(3, 2);
    ASSERT_TRUE(availability.addSubtree(
        OctreeTileID{0, 0, 0, 0},
        makeOctreeFixtureRootSubtree()));
    const TileAvailabilityNode* root = availability.rootNode();
    ...
    EXPECT_NE(0, availability.computeAvailability(OctreeTileID{2, 0, 0, 0}));
    EXPECT_EQ(0, availability.computeAvailability(OctreeTileID{3, 0, 0, 0}));
    EXPECT_NE(
        0,
        availability.computeAvailability(OctreeTileID{3, 0, 0, 0}, root));
}
...
TEST(TileOctreeAvailabilityTest, AddSubtreeIgnoresMaximumLevelLikeCesiumNative) {
    TileOctreeAvailability availability(3, 2);
    ASSERT_TRUE(availability.addSubtree(
        OctreeTileID{0, 0, 0, 0},
        makeOctreeFixtureRootSubtree()));
...
TEST(TileOctreeAvailabilityTest, AddSubtreeRejectsInvalidSubtreeAvailabilityAccessorLikeCesiumNative) {
    TileOctreeAvailability availability(3, 5);
    ASSERT_TRUE(availability.addSubtree(
        OctreeTileID{0, 0, 0, 0},
        makeInvalidSubtreeAvailabilityRootSubtree()));
    TileAvailabilityNode* root = availability.rootNode();
    ASSERT_NE(nullptr, root);
    const OctreeTileID childId{3, 0, 0, 0};
    ...
    EXPECT_FALSE(availability.addSubtree(
        ...
        TileAvailabilitySubtree{
            ...
            ConstantTileAvailability{false},
            {}}));
    EXPECT_EQ(nullptr, availability.findChildNode(childId, root));
}
...
TEST(TileOctreeAvailabilityTest, AddNodeIgnoresMaximumLevelLikeCesiumNative) {
    TileOctreeAvailability availability(3, 2);
    ASSERT_TRUE(availability.addSubtree(
        OctreeTileID{0, 0, 0, 0},
        makeOctreeFixtureRootSubtree()));
    ...
    const OctreeTileID id{3, 0, 0, 0};
    TileAvailabilityNode* node = availability.addNode(id, root);
    ASSERT_NE(nullptr, node);
    EXPECT_EQ(node, availability.findChildNode(id, root));
    EXPECT_EQ(0, availability.computeAvailability(id));
}
...
TEST(TileOctreeAvailabilityTest, AddNodeRejectsInvalidSubtreeAvailabilityAccessorLikeCesiumNative) {
    TileOctreeAvailability availability(3, 5);
    ASSERT_TRUE(availability.addSubtree(
        OctreeTileID{0, 0, 0, 0},
        makeInvalidSubtreeAvailabilityRootSubtree()));
    ...
    EXPECT_EQ(nullptr, availability.addNode(childId, root));
    EXPECT_EQ(nullptr, availability.findChildNode(childId, root));
}
